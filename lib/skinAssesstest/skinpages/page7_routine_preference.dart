...
class RoutinePreferencePage extends StatefulWidget {
  ...
  const RoutinePreferencePage({Key? key, required this.userSkinData})
      : super(key: key);
...
class _RoutinePreferencePageState extends State<RoutinePreferencePage> {
  ...
  final List<Map<String, String>> routineOptions = [
    {
      'label': 'Minimal (Quick and Easy)',
      'image': 'assets/skinimages/steps.png'
    },
    {'label': 'Moderate (Few Steps)', 'image': 'assets/skinimages/steps.png'},
    {
      'label': 'Extensive (Full Routine)',
      'image': 'assets/skinimages/steps.png'
    },
  ];
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            Text('What is your skincare routine preference?',
              ...
              child: ElevatedButton(
                ...
                onPressed: () {
                  if (_selectedPreference == null) {
                    // Show a Snackbar if no preference is selected
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(
                        content: Text(
                            'Please select a skincare routine preference before proceeding.'),
